...
<fieldset>
    <legend><?php echo t('Product Arrangement')?></legend>
    <?php 
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="form-group" id="pageselector">
                <div class="form-group" <?php echo  ($filter == 'page' || $filter == 'page_children' ? '' : 'style="display: none"'); ?> >
                    <?php 
