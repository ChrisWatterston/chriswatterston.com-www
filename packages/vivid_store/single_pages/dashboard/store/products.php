    ...
    <form method="post" action="<?php echo $view->action('save')?>">
        ...
        <div class="row">
            ...
            <div class="col-sm-7 store-pane active" id="product-overview">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <div class="form-group" id="backorders" <?php echo  ($p->pQtyUnlim ? 'style="display: none"' : '');?>>
            ...
            <div class="col-sm-7 store-pane" id="product-categories">
                ...
                <div class="form-group" id="page_pickers">
                    ...
                    <?php  for($i = 1; $i < 7; $i++) { ?>
                        <div class="page_picker <?php echo  ($pages[$i -1]['cID']  ? '' : 'picker_hidden' ); ?>">
            ...
            <div class="col-sm-7 store-pane" id="product-options">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-4 text-right">
                                    <a href="javascript:addOptionItem(<%=sort%>)" data-group="<%=sort%>" class="btn btn-default btn-add-option-item"><i data-toggle="tooltip" data-placement="top" title="<?php echo t('Add Option to the Group')?>" class="fa fa-plus"></i></span>
                    ...
                    <div class="option-item clearfix form-horizontal" data-order="<%=sort%>" data-option-group="<%=optGroup%>">
                        <div class="form-group">
                            <div class="col-sm-3 text-right">
                                <label class="grabme"><?php echo t('Option')?>:</label>
                            </div>
                            <div class="col-sm-5">
                ...
                <script type="text/javascript">
                    ...
                    $(function(){
                        ...
                        optItemsContainer.append(optItemsTemplate({
                            poiName: '<?php echo $option['poiName']?>',
                            optGroup: <?php echo $i?>,
                            sort: <?php echo $option['poiSort']?>
        ...
        <div class="ccm-dashboard-form-actions-wrapper">
            <div class="ccm-dashboard-form-actions">
                ...
                <button class="pull-right btn btn-success" type="submit" ><?php echo t('%s Product',$actionType)?></button>
            </div>
        </div>
            ...
            <?php  if(count($products)>0) {
                foreach ($products as $p) {
                    ...
                    <tr>
                        ...
                        <td><strong><a href="<?php  echo View::url('/dashboard/store/products/edit/', $p->getProductID())?>"><?php echo  $p->getProductName() ?></a></strong></td>
                        <td>
                            <?php 
                            if ($p->isActive()) {
                        ...
                        <td>
                            ...
                            foreach($productgroups as $pg) { ?>
                                <span class="label label-primary"><?php echo  $pg; ?></span>
                             <?php  } ?>
