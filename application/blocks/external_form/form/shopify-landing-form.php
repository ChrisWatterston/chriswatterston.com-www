    ...
    try {
      $message = array(
          'html' => '
                  ...
                  ',
          'subject' => 'Shopify - Form Submission',
...
<div class="form-results">
  ...
  if ($result[0][status] === 'rejected') {
    echo "<p class='alert-error'>Thank you for your eCommerce submission, but something went wrong. Please try again, otherwise pop me an email via hello@chriswatterston.com.</p>";
  }
...
<div class="landing-form">
  ...
  <form method="post" class="form-grey colour-grey" name="form_submit" action="<?php echo $_SERVER['PHP_SELF']; ?>#ecommerce-form">
    <div class="cols">
      ...
      <div class="col full">
          <input type="submit" name="form_submit" value="Submit eCommerce Enquiry" class="btn btn-default abtn shopify" />
      </div>
    </div>
  </form>
