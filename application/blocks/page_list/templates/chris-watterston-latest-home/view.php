		...
		<div class="col newsfeed-entry entry-<?php echo $i; ?> <?php echo $posttyperesult; ?>">
			...
			<div class="news-content-wrap">
				<div class="news-content">
		            <?php if ($includeName): ?>
		            	<h2 class="colour-white type-semibold"><?php echo $title ?></h2>
		            <?php endif; ?>
		            <p class="date-tag colour-white type-semibold type-uppercase">
			            <?php if ($includeDate) { echo $date; } ?> <span class="type-closetag"></span> <?php echo $microposttag, $posttypetitlefirst, " Post"; ?>
		            </p>
					<p class="description colour-white">
