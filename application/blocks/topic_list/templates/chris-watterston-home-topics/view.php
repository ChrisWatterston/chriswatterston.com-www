...
-->
                ...
                <?php } else { ?>
	            	...
	            	<li>
	            		<a class="topic-list-link colour-white type-lowercase" title="Filter by '<?php echo $topic->getTreeNodeDisplayName(); ?>'" href="<?php echo $view->controller->getTopicLink($topic); ?>"<?php if (isset($selectedTopicID) && $selectedTopicID == $topic->getTreeNodeID()) { ?>class="ccm-block-topic-list-topic-selected"<?php } ?>>
							<?php echo $topic->getTreeNodeDisplayName(); ?>
						</a>
					</li>
