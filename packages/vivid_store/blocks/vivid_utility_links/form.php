...
<div class="checkbox">
    <label>
        ...
        <?php echo t('Show Amount of Items in Cart')?>
    </label>
</div>
...
<div class="checkbox">
    <label>
        ...
        <?php echo t('Show Greeting  (Welcome back, FirstName)')?>
    </label>
</div>
...
<div class="checkbox">
    <label>
        ...
        <?php echo t('Link to popup cart instead of cart page')?>
    </label>
</div>
