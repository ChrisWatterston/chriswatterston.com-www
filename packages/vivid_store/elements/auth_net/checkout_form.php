...
<div class="clearfix col-container">
    <div class="vivid-store-col-2">
        <div class="form-group">
            <label for="checkout-credit-card"><?php echo t("Credit Card Number")?></label>
    ...
    <div class="vivid-store-col-2">
        <div class="col-container">
            <div class="form-group vivid-store-col-2">
                <label for="checkout-exp-month"><?php echo t("Month")?></label>
            ...
            <div class="form-group vivid-store-col-2">
                <label for="checkout-exp-year"><?php echo t("Year")?></label>
