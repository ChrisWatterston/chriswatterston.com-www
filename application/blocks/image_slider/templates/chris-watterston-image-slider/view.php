...
<?php } else { ?>
  ...
  <div class="casestudy-slider ccm-image-slider-container ccm-block-image-slider-<?php echo $navigationTypeText?>" >
              ...
              <?php foreach ($rows as $row) { ?>
                <li>
                  ...
                  <div class="ccm-image-slider-text">
                    <?php if ($row['title']) { ?>
                      <h3 class="ccm-image-slider-title type-semibold"><?php echo $row['title'] ?></h3>
                    <?php } ?>
