    ...
    try {
      $message = array(
          'html' => '
                  ...
                  ',
          'subject' => 'Website Design - Form Submission',
...
<div class="form-results">
  ...
  if ($result[0][status] === 'sent') {
    echo "<p class='alert-success'>Thank you for your Website Design form submission. Once received, we'll be back in touch as soon as we can - speak soon!</p>";
  }
  ...
  if ($result[0][status] === 'rejected') {
    echo "<p class='alert-error'>Thank you for your Website Design submission, but something went wrong. Please try again, otherwise pop me an email via hello@chriswatterston.com.</p>";
  }
...
<div class="landing-form">
  ...
  <form method="post" class="form-grey colour-grey" name="form_submit" action="<?php echo $_SERVER['PHP_SELF']; ?>#websitedesign-form">
    <div class="cols">
      <div class="col">
      ...
      <div class="col full">
          <input type="submit" name="form_submit" value="Submit Website Enquiry" class="btn btn-default abtn blue-dark" />
      </div>
    </div>
  </form>
