    ...
    <div class="<?= $globalPrefix; ?>-body-container">
        ...
        <section class="<?= $globalPrefix; ?>-stream-container _listing _max-width__1280 ">
            <section class="<?= $globalPrefix; ?>-intro-container _intro _text-align__center">
                ...
                <h3 class="_intro">Agile & visionary <a href="/about" data-cabin-event="Home / Intro Main" title="Agile and visionary Digital Product Designer & Product Manager in London" class="_link-colour__purple">Digital Product Designer</a> with a strong background in <a href="/about" data-cabin-event="Home / Intro Sec" title="background in Digital Marketing, User Experience (UX), and Web Development." class="_link-colour__purple">Web Development, UX, and Digital Marketing.</a></h3>
            </section>
