    ...
    <div class="<?= $globalPrefix; ?>-body-container">
        ...
        <section class="<?= $globalPrefix; ?>-stream-container _listing _max-width__1280 ">
            <section class="<?= $globalPrefix; ?>-intro-container _intro _text-align__center">
                ...
                <h3 class="_intro">Agile & visionary <a href="/about" data-cabin-event="Home / Intro Main" title="Agile and visionary Digital Product Designer & Product Manager in London" class="_link-colour__purple">Digital Product Designer</a> with a strong background in <a href="/about" data-cabin-event="Home / Intro Sec" title="background in Digital Marketing, User Experience (UX), and Web Development." class="_link-colour__purple">Web Development, US, and Digital Marketing.</a></h3>
            </section>
            <div class="<?= $globalPrefix; ?>-grid-container _work-latest _listing _work">
                ...
                foreach ($jsonWorkOutput as $k => $v) {
                    ...
                    echo '
                            ...
                            <a href="/work/case-study/' . $v['workUrlSlug'] . '" data-cabin-event="Embed / Home to Work" class="_hidden" title="' . $v['workTitle'] . '">&#32;</a>
                        </article>
                    ';
                }
                ?>
            ...
            <div class="<?= $globalPrefix; ?>-grid-container _column-3 _listing">
                ...
                foreach ($jsonBlogOutput as $k => $v) {
                    ...
                    <article class="' . $globalPrefix . '-card-container _listing">
                        ...
                        <a href="/article/' . $v['articleUrlSlug'] . '" data-cabin-event="Embed / Home to Article" class="_hidden" title="' . $v['articleTitle'] . '">&#32;</a>
                    </article>
                ';
                }
                ?>
